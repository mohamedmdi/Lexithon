...
const data = {
  school: {
    ...
    data: [
      ...
      { word: "Calendrier", img: IMAGES.calendrier, sound: AUDIOS.calendrier },
      { word: "Drapeau", img: IMAGES.drapeau, sound: AUDIOS.drapeau },
      { word: "Projecteur ", img: IMAGES.projecteur, sound: AUDIOS.projecteur },
      { word: "Imprimante ", img: IMAGES.imprimante, sound: AUDIOS.imprimante },
      { word: "Brosse ", img: IMAGES.brosse, sound: AUDIOS.brosse },
      { word: "Stylo ", img: IMAGES.stylo, sound: AUDIOS.stylo },
      { word: "Ordinateur ", img: IMAGES.ordinateur, sound: AUDIOS.ordinateur },
  ...
  home: {
    ...
    data: [
      ...
      { word: "Télévision", img: IMAGES.television, sound: AUDIOS.television },
  ...
  kitchen: {
    ...
    data: [
      ...
      { word: "Fourchette", img: IMAGES.fourchette, sound: AUDIOS.fourchette },
      ...
      { word: "Cuisinière", img: IMAGES.cuisiniere, sound: AUDIOS.cuisiniere },
  ...
  animals: {
    ...
    data: [
      ...
      { word: "Poulailler", img: IMAGES.poulailler, sound: AUDIOS.poulailler },
      ...
      { word: "Hirondelle", img: IMAGES.hirondelle, sound: AUDIOS.hirondelle },
  ...
  body: {
    ...
    data: [
      ...
      { word: "Chaussures", img: IMAGES.chaussures, sound: AUDIOS.chaussures },
  ...
  sport: {
    ...
    data: [
      ...
      { word: "Patins à roulettes", img: IMAGES.patins, sound: AUDIOS.patins },
      ...
      { word: "Balançoire", img: IMAGES.balancoire, sound: AUDIOS.balancoire },
